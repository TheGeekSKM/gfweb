...
export function CreateNewCharExperiences(k: KAPLAYCtx, ) : void
{
    ...
    const experienceAddContainer = fullBorder.add([
        k.rect(fullBorder.width - 40, 200, {radius: 10}),
        k.pos(0, -fullBorder.height / 2 + 250),
        k.anchor("center"),
        k.color(k.rgb(56, 90, 153)),
    ]);

    const experienceAddTitle = experienceAddContainer.add([
        k.text("Add Experience", {size: 24, font: "monogram", width: experienceAddContainer.width - 20, align: "center"}),
        k.pos(0, -experienceAddContainer.height / 2 + 30),
        k.anchor("center"),
        k.color(k.rgb(5, 5, 5)),
    ]);
    ...
    const experienceInputFieldPosition = k.add([
        ...
        k.pos(k.center().x, k.center().y + experienceAddContainer.pos.y - 10),
        k.anchor("center"),
    ...
    const experienceListContainer = fullBorder.add([
        k.rect(fullBorder.width - 40, fullBorder.height - 450, {radius: 10}),
        k.pos(0, fullBorder.height / 2 - ((fullBorder.height - 350) / 2) - 25),
        k.anchor("center"),
        k.color(k.rgb(56, 90, 153)),
        k.mask("intersect"),
    ]);
    ...
    if (experienceInputField) {
        ...
        experienceInputField.style.width = "300px";
