...
export function IncreaseHPUpgrade(k: KAPLAYCtx) : void
{
    
    k.scene("increaseHPUpgrade", () => {
        AppStore.SetState((prevState) => ({
            ...prevState,
            currentScene: "increaseHPUpgrade",
            previousScene: prevState.currentScene,
        }), "IncreaseHPUpgradeScene");
        ...
        const titleText = fullBorder.add([
            k.text("Increase Max Hit Points", { size: 36, font: "monogram", width: k.width() - 40, align: "center" }),
        ...
        const subtitleText = fullBorder.add([
            k.text("Increase your Max Hit Points by 1 or whatever number your Dealer mentioned.", { size: 18, font: "monogram", width: k.width() - 40, align: "center" }),
        ...
        const proceedButtonText = proceedButton.add([
            k.text("Finish", { size: 20, font: "monogram", width: proceedButton.width - 20, align: "center" }),
            k.pos(0, 0),
            k.anchor("center"),
            k.color(k.rgb(5, 5, 5)),
        ]);
        ...
        hitPointsInputField.value = `${AppStore.GetState().player.maxHitPoints}`;
